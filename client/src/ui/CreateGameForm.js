  ...
  return (
    ...
    >
      <Form.Item label="Name" name="name" rules={[{ required: true, message: 'Input the name' }]}><Input /></Form.Item>
          ...
          <Form.Item label="NA sales" name="na_sales" rules={[{ required: true }]}><InputNumber /></Form.Item>
          <Form.Item label="EU sales" name="eu_sales" rules={[{ required: true }]}><InputNumber /></Form.Item>
          <Form.Item label="JP sales" name="jp_sales" rules={[{ required: true }]}><InputNumber /></Form.Item>
          <Form.Item label="Other sales" name="other_sales" rules={[{ required: true }]}><InputNumber /></Form.Item>
    </Form>
  );
};
